 ...
 */
package de.hybris.fashion.fulfilmentprocess.test;
...
import de.hybris.fashion.fulfilmentprocess.test.actions.TestActionTemp;
...
public class ProcessFlowTest extends HybrisJUnit4Test
{
	...
	public static void prepare() throws Exception
	{
		...
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/fashionfulfilmentprocess/test/fashionfulfilmentprocess-spring-test.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/fashionfulfilmentprocess/test/process/order-process-spring.xml"));
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/fashionfulfilmentprocess/test/process/consignment-process-spring.xml"));
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/fashionfulfilmentprocess/test/fashionfulfilmentprocess-spring-testcleanup.xml"));
