...
import de.hybris.fashion.fulfilmentprocess.actions.order.SendAuthorizationFailedNotificationAction;
...
public class SendAuthorizationFailedNotificationTest
{
	...
	/**
	 * Test method for
	 * {@link de.hybris.fashion.fulfilmentprocess.actions.order.SendOrderPlacedNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
