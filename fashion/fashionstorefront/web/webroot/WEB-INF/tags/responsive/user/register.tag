...
<form:form method="post" modelAttribute="registerFormCustom" action="${action}">
	...
	<formElement:formPasswordBox idKey="register.checkPwd"
		...
		mandatory="true" />
    <formElement:formInputBox idKey="register.occupation" labelKey="register.occupation"
	path="occupation" inputCSS="form-control" mandatory="false" /> 
    <formElement:formInputBox idKey="register.income" labelKey="register.income"
	path="income" inputCSS="form-control" mandatory="false" />
