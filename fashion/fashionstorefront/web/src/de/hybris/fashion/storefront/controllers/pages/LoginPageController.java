 ...
 */
package de.hybris.fashion.storefront.controllers.pages;


import static de.hybris.platform.commercefacades.constants.CommerceFacadesConstants.CONSENT_GIVEN;

import de.hybris.fashion.storefront.controllers.ControllerConstants;
import de.hybris.fashion.storefront.forms.RegisterFormCustom;
...
public class LoginPageController extends AbstractLoginPageController
{
	...
	/*
	 * @Resource(name = "ezDefaultCustomerFacade") private EZCustomerFacade ezCustomerFacade;
	 */
	...
	final String referer, final RegisterFormCustom form, final BindingResult bindingResult, final Model model,
			final HttpServletRequest request, final HttpServletResponse response, final RedirectAttributes redirectModel)
			throws CMSItemNotFoundException
	{
		System.out.println("Data Received: " + form.toString());
			...
			throws CMSItemNotFoundException
	{
		...
		model.addAttribute(new RegisterFormCustom());
	...
	protected String processRegisterUserRequest(final String referer, final RegisterFormCustom form,
			...
			final HttpServletResponse response, final RedirectAttributes redirectModel) throws CMSItemNotFoundException // NOSONAR
	{
		...
		data.setOccupation(form.getOccupation());
		data.setIncome(form.getIncome());
		try
		{
			System.out.println("Inside: ---PRE--- processRegisterUserRequest : data : Income : " + data.getIncome()
					+ ", Occupation: " + data.getOccupation());
			getCustomerFacade().register(data);
			System.out.println("Inside: ---POST--- processRegisterUserRequest : data : Income : " + data.getIncome()
					+ ", Occupation: " + data.getOccupation());
